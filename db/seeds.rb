...
LSIL13 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '7:00, 12:00', findings: 'dense AW, sharp border', ECC: 'Yes')
   ...
   LSIL13AWGreen1 = Image.create(image_type: 'Acetic Acid + Green Filter 1', img_url: 'LSIL 13 AW green.jpg', image_set: LSIL131)
      GreenArea.create(coordinates: '203,518,190,537,198,562,228,562,246,549,243,528,230,510', shape: 'poly', image: LSIL13AWGreen1)
      GreenArea.create(coordinates: '162,400,221,385,312,384,358,388,383,398,394,382,406,321,414,287,399,258,387,238,378,204,374,152,351,128,307,118,275,136,250,161,224,202,230,160,231,135,225,120,210,116,192,124,180,140,172,163,160,197,156,238,149,316', shape: 'poly', image: LSIL13AWGreen1)
      GreenArea.create(coordinates: '174,402,188,415,165,422,131,422,106,420,94,442,116,457,148,476,168,498,211,499,243,476,251,451,267,431,279,424,268,402,220,391,197,394', shape: 'poly', image: LSIL13AWGreen1)
      BlueArea.create(image: LSIL13AWGreen1)
   LSIL13AWGreen2 = Image.create(image_type: 'Acetic Acid + Green Filter 2', img_url: 'LSIL 13 AW green 2.jpg', image_set: LSIL13)
      GreenArea.create(coordinates: '?', shape: 'poly', image: LSIL13AWGreen2)
      BlueArea.create(image: LSIL13AWGreen2)
...
LSIL15 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '6:00, 9:00, 12:00', findings: 'thin AW, irregular border, geographic', ECC: 'No')
   ...
   LSIL15AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'LSIL 15 AW green.jpg', image_set: LSIL15)
      GreenArea.create(coordinates: '279,354,244,334,237,297,203,279,154,278,129,284,106,274,102,244,116,208,140,167,178,124,252,45,290,22,337,11,370,24,384,26,425,11,449,19,481,35,503,58,533,113,538,160,532,211,523,238,504,255,442,285,380,321,339,344,314,355/532,225,537,193,575,174,605,174,612,203,594,228,560,238,530,243', shape: 'poly', image: LSIL15AWGreen)
   ...
   LSIL15Lugols = Image.create(image_type: "Lugol's", img_url: 'LSIL 15 Lugol_s.jpg', image_set: LSIL15)
      GreenArea.create(coordinates: '?', shape: 'poly', image: LSIL15Lugols)
...
LSIL16 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '1:00, 7:00', findings: 'thin AW, irregular border ', ECC: 'Yes')
   ...
   LSIL16AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'LSIL 16 AW green.jpg', image_set: LSIL16)
      GreenArea.create(coordinates: '308,548,265,511,232,469,214,402,232,355,269,321,303,306,349,312,354,326,359,375,334,409,313,445,308,482,329,501,349,509,338,533', shape: 'poly', image: LSIL16AWGreen)
      GreenArea.create(coordinates: '458,437,432,438,410,457,393,485,383,512,388,551,413,546,451,536,465,518,479,484,490,438', shape: 'poly', image: LSIL16AWGreen)
      GreenArea.create(coordinates: '469,336,486,356,513,349,551,351,572,334,590,292,598,265,610,234,595,210,569,191,561,172,534,148,519,140,502,142,515,110,507,90,492,75,469,67,450,58,422,44,394,44,372,45,349,53,338,87,324,104,338,140,341,165,333,191,339,221,362,254,379,292,408,320', shape: 'poly', image: LSIL16AWGreen)
   ...
   LSIL16Lugols = Image.create(image_type: "Lugol's", img_url: 'LSIL 16 Lugol_s.jpg', image_set: LSIL16)
      GreenArea.create(coordinates: '?', shape: 'poly', image: LSIL16Lugols)
