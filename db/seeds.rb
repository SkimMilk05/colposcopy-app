...
HSIL14 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '3:00 - 9:00', findings: 'dense AW, cuffed crypt, sharp border, rag sign', impression: 'high grade' , ECC: 'Yes')
   ...
   HSIL14AW1 = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 14 AW.jpg', ans_img_url: 'InkedHSIL 14 AW_LI.jpg', image_set: HSIL14)
   ...
   HSIL14AW2 = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 14 AW 2.jpg', ans_img_url: 'InkedHSIL 14 AW 2_LI.jpg', image_set: HSIL14)
   ...
   HSIL14AW3 = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 14 AW 3 into vagina.jpg', ans_img_url: 'InkedHSIL 14 AW 3 into vagina_LI.jpg', image_set: HSIL14)
