...
#UVA image sets--------------------------------------------------------
C107 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', findings: '', lesion_location: '5:00, 12:00', impression: 'low grade' , ECC: 'Benign')

   C107_Pre = Image.create(image_type: 'Speculum Exam', img_url: 'C107_Pre.JPG', ans_img_url: '', image_set: C107)

   C107_Post = Image.create(image_type: 'Acetic Acid', img_url: 'C107_Post.JPG', ans_img_url: 'C107 AW outlined.JPG', image_set: C107)
   C107_Green = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'C107_Green.JPG', ans_img_url: 'C107 AW green outlined.JPG', image_set: C107)
...
C109 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', findings: '', lesion_location: '1:00, 11:00', impression: 'low grade' , ECC: 'Not Done')
   C109_Pre = Image.create(image_type: 'Speculum Exam', img_url: 'C109_Pre.JPG', ans_img_url: '', image_set: C109)

   C109_Post = Image.create(image_type: 'Acetic Acid', img_url: 'C109_Post.JPG', ans_img_url: 'C109 AW outlined.JPG', image_set: C109)
   ...
   C109_Green = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'C109_Green.JPG', ans_img_url: 'C109 AW green outlined.JPG', image_set: C109)
...
SCC1 = ImageSet.create(category: 'Cancers: Squamous Cell', pathology: 'microinvasive SCC', lesion_location: '11:00 - 2:00', findings: 'dense AW area, coarse punctations, sharp raised border, erosion', impression: 'suspicious for invasion' , ECC: 'Yes')
   SCC1Pre = Image.create(image_type: 'Speculum Exam', img_url: 'SCC1AW.jpg', ans_img_url: '', image_set: SCC1)

   SCC1AW = Image.create(image_type: 'Acetic Acid', img_url: 'SCC1AW.jpg', ans_img_url: 'SCC 1 AW zoom outlined.jpg', image_set: SCC1)
   ...
   SCC1AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'SCC1AWGreen.jpg', ans_img_url: 'SCC 1 AW green outlined.jpg', image_set: SCC1)
...
SCC8 = ImageSet.create(category: 'Cancers: Squamous Cell', pathology: 'invasive SCC', lesion_location: '4:00 - 10:00', findings: 'dense AW, coarse punctation, sharp border, atypical vessels, fragile vessels, irregular surface', impression: 'suspicious for invasion' , ECC: 'Yes')
   SCC8Pre = Image.create(image_type: 'Normal Saline', img_url: 'SCC8NS.jpg', ans_img_url: '', image_set: SCC8)

   SCC8AW = Image.create(image_type: 'Acetic Acid', img_url: 'SCC8AW.jpg', ans_img_url: 'SCC 8 AW outlined.jpg', image_set: SCC8)
   ...
   SCC8AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'SCC8AWGreen.jpg', ans_img_url: 'SCC 8 AW + green 2 outlined.jpg', image_set: SCC8)
   ...
   SCC8Lugols = Image.create(image_type: "Lugol's", img_url: 'SCC8Lugols.jpg', ans_img_url: 'SCC 8 Lugol outlined.jpg', image_set: SCC8)
...
HSIL1 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 2', lesion_location: '11:00, 2:00, 5:00', findings: 'dense AW, sharp border ', impression: 'high grade' , ECC: 'No')
   ...
   HSIL1AW2 = Image.create(image_type: 'Acetic Acid 2', img_url: 'HSIL 1 AW 2.jpg', ans_img_url: 'InkedHSIL 1 AW 2_LI.jpg', image_set: HSIL1)
   ...
   HSIL1AW3 = Image.create(image_type: 'Acetic Acid 3', img_url: 'HSIL 1 AW 3.jpg', ans_img_url: 'InkedHSIL 1 AW 3_LI.jpg', image_set: HSIL1)
...
HSIL2 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 2', lesion_location: '2:00 - 6:00, 12:00 - 1:00', findings: 'dense AW, sharp border ', impression: 'high grade' , ECC: 'No')
   HSIL2Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 2 NS.jpg', image_set: HSIL2)

   HSIL2AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 2 AW.jpg', ans_img_url: 'InkedHSIL 2 AW_LI.jpg', image_set: HSIL2)
   ...
   HSIL2AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'HSIL 2 AW green.jpg', ans_img_url: 'InkedHSIL 2 AW_LI.jpg', image_set: HSIL2)
   ...
   HSIL2Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 2 Lugol_s.jpg', ans_img_url: 'InkedHSIL 2 Lugol_s_LI.jpg', image_set: HSIL2)
...
HSIL5 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 2', lesion_location: '1:00, 5:00, 7:00, 11:00', findings: 'dense AW, sharp border', impression: 'high grade' , ECC: 'No')
   HSIL5Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 5 NS green.jpg', image_set: HSIL5)

   HSIL5AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 5 AW.jpg', ans_img_url: 'InkedHSIL 5 AW_LI.jpg', image_set: HSIL5)
   ...
   HSIL5Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 5 Lugol_s.jpg', ans_img_url: 'InkedHSIL 5 Lugol_s_LI.jpg', image_set: HSIL5)
...
HSIL6 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 2', lesion_location: '3:00 - 8:00', findings: 'dense AW, sharp border', impression: 'high grade' , ECC: 'No')
   HSIL6Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 6 NS.jpg', image_set: HSIL6)

   HSIL6AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 6 AW.jpg', ans_img_url: 'InkedHSIL 6 AW_LI.jpg', image_set: HSIL6)
   ...
   HSIL6Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 6 Lugol_s.jpg', ans_img_url: 'InkedHSIL 6 Lugol_s_LI.jpg', image_set: HSIL6)
...
HSIL7 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 2', lesion_location: '6:00, 8:00', findings: 'dense AW, sharp border', impression: 'high grade' , ECC: 'No')
   ...
   HSIL7AW2 = Image.create(image_type: 'Acetic Acid 2', img_url: 'HSIL 7 AW 2.jpg', ans_img_url: 'InkedHSIL 7 AW 2_LI.jpg', image_set: HSIL7)
   ...
   HSIL7Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 7 Lugol_s.jpg', ans_img_url: 'InkedHSIL 7 Lugol_s_LI.jpg', image_set: HSIL7)
...
HSIL8 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 2', lesion_location: '4:00', findings: 'dense AW, sharp border', impression: 'high grade' , ECC: 'No')
   HSIL8Pre = Image.create(image_type: 'Speculum Exam', img_url: 'HSIL 8 AW.jpg', image_set: HSIL8)

   HSIL8AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 8 AW.jpg', ans_img_url: 'InkedHSIL 8 AW_LI.jpg', image_set: HSIL8)
      GreenArea.create(coordinates: '519,467,489,443,451,422,432,405,429,382,454,351,496,330,531,315,548,310,564,290,588,289,621,313,628,340,590,388,559,436,541,458', shape: 'poly', image: HSIL8AW)
   HSIL8AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'HSIL 8 AW green.jpg', ans_img_url: 'InkedHSIL 8 AW green_LI.jpg', image_set: HSIL8)
      GreenArea.create(coordinates: '599,362,562,331,566,313,558,303,563,282,584,268,580,242,594,225,624,219,647,184,681,175,745,155,772,177,783,212,785,245,770,266,774,311,757,342,722,365,708,345,679,348,652,343,626,358', shape: 'poly', image: HSIL8AWGreen)
   HSIL8Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 8 Lugol_s.jpg', ans_img_url: 'InkedHSIL 8 Lugol_s_LI.jpg', image_set: HSIL8)
      GreenArea.create(coordinates: '549,221,610,204,642,185,661,171,680,180,689,240,667,263,681,282,688,303,675,325,649,333,621,319,615,353,596,361,577,359,556,337,535,307,543,279,560,255', shape: 'poly', image: HSIL8Lugols)

HSIL15 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 2', lesion_location: '12:00', findings: 'dense AW, sharp border', impression: 'high grade' , ECC: 'Yes')
   HSIL15Pre = Image.create(image_type: 'Speculum Exam', img_url: 'HSIL 15 AW.jpg', image_set: HSIL15)

   HSIL15AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 15 AW.jpg', ans_img_url: 'InkedHSIL 15 AW_LI.jpg', image_set: HSIL15)
   ...
   HSIL15Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 15 Lugol_s.jpg', ans_img_url: 'InkedHSIL 15 Lugol_s_LI.jpg', image_set: HSIL15)
...
HSIL16 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 2', lesion_location: '2:00', findings: 'dense AW, sharp border', impression: 'high grade' , ECC: 'No')
   HSIL16Pre = Image.create(image_type: 'Speculum Exam', img_url: 'HSIL 16 pre.jpg', image_set: HSIL16)

   HSIL16AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 16 AW.jpg', ans_img_url: 'InkedHSIL 16 AW_LI.jpg', image_set: HSIL16)
   ...
   HSIL16Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 16 Lugol_s.jpg', ans_img_url: 'InkedHSIL 16 Lugol_s_LI.jpg', image_set: HSIL16)
...
HSIL17 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 2', lesion_location: '12:00', findings: 'dense AW, sharp border', impression: 'high grade' , ECC: 'Yes')
   HSIL17Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 17 NS.jpg', image_set: HSIL17)

   HSIL17AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 17 AW.jpg', ans_img_url: 'InkedHSIL 17 AW_LI.jpg', image_set: HSIL17)
   ...
   HSIL17Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 17 Lugol_s.jpg', ans_img_url: 'InkedHSIL 17 Lugol_s_LI.jpg', image_set: HSIL17)
...
HSIL29 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 2', lesion_location: '4:00 - 7:00', findings: 'dense AW, sharp border', impression: 'high grade' , ECC: 'Yes')
   HSIL29Pre = Image.create(image_type: 'Speculum Exam', img_url: 'HSIL 29 pre.jpg', image_set: HSIL29)

   HSIL29AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 29 AW.jpg', ans_img_url: 'InkedHSIL 29 AW 2_LI.jpg', image_set: HSIL29)
      GreenArea.create(coordinates: '396,319,351,304,300,284,243,267,197,277,194,306,231,321,275,337,324,360,352,389,379,406,411,400,429,386,428,347,414,327', shape: 'poly', image: HSIL29AW)
      BlueArea.create(image: HSIL29AW)

HSIL31 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 2', lesion_location: '7:00 - 10:00', findings: 'dense AW, sharp border, erosion', impression: 'high grade' , ECC: 'No')
   HSIL31Pre = Image.create(image_type: 'Speculum Exam', img_url: 'HSIL 31 AW 2.jpg', image_set: HSIL31)

   HSIL31AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 31 AW 2.jpg', ans_img_url: 'InkedHSIL 31 AW 2_LI.jpg', image_set: HSIL31)
   ...
   HSIL31Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 31 Lugol_s.jpg', ans_img_url: 'InkedHSIL 31 AW 2_LI.jpg', image_set: HSIL31)
...
HSIL33 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 2', lesion_location: '3:00 - 10:00', findings: 'dense AW, coarse mosaic, erosion', impression: 'high grade' , ECC: 'Yes')
   HSIL33Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 33 NS.jpg', image_set: HSIL33)

   HSIL33AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 33 AW.jpg', ans_img_url: 'InkedHSIL 33 AW_LI.jpg', image_set: HSIL33)
   ...
   HSIL33AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'HSIL 33 AW green.jpg', ans_img_url: 'InkedHSIL 33 AW green_LI.jpg', image_set: HSIL33)
   ...
   HSIL33Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 33 Lugol_s.jpg', ans_img_url: 'InkedHSIL 33 Lugol_s_LI.jpg', image_set: HSIL33)
...
#CIN3
HSIL9 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '3:00 - 7:00', findings: 'coarse mosaic, erosion', impression: 'high grade' , ECC: 'No')
   HSIL9Pre = Image.create(image_type: 'Speculum Exam', img_url: 'HSIL 9 pre.jpg', image_set: HSIL9)

   HSIL9AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 9 AW.jpg', ans_img_url: 'InkedHSIL 9 AW 2_LI.jpg', image_set: HSIL9)
   ...
   HSIL9AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'HSIL 9 AW green.jpg', ans_img_url: 'InkedHSIL 9 AW green_LI.jpg', image_set: HSIL9)
   ...
   HSIL9Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 9 Lugol_s.jpg', ans_img_url: 'InkedHSIL 9 Lugol_s_LI.jpg', image_set: HSIL9)
...
HSIL11 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '6:00 - 8:00', findings: 'dense AW, sharp border, cuffed crypts', impression: 'high grade' , ECC: 'No')
   HSIL11Pre = Image.create(image_type: 'Speculum Exam', img_url: 'HSIL 11 pre.jpg',  image_set: HSIL11)

   HSIL11AW1 = Image.create(image_type: 'Acetic Acid 1', img_url: 'HSIL 11 AW.jpg', ans_img_url: 'InkedHSIL 11 AW_LI.jpg', image_set: HSIL11)
   ...
   HSIL11AW2 = Image.create(image_type: 'Acetic Acid 2', img_url: 'HSIL 11 AW 2.jpg', ans_img_url: 'InkedHSIL 11 AW 2_LI.jpg', image_set: HSIL11)
   ...
   HSIL11AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'HSIL 11 AW green.jpg', ans_img_url: 'InkedHSIL 11 AW green_LI.jpg', image_set: HSIL11)
...
HSIL12 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '6:00 - 8:00', findings: 'dense AW, sharp border, cuffed crypts', impression: 'high grade' , ECC: 'No')
   ...
   HSIL12AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 12 AW.jpg', ans_img_url: 'InkedHSIL 12 AW_LI.jpg', image_set: HSIL12)
   ...
   HSIL12AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'HSIL 12 AW green.jpg', ans_img_url: 'InkedHSIL 12 AW green_LI.jpg', image_set: HSIL12)
   ...
   HSIL12Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 12 Lugol_s.jpg', ans_img_url: 'InkedHSIL 12 Lugol_s_LI.jpg', image_set: HSIL12)
...
HSIL13 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '5:00 - 8:00, 10:00', findings: 'dense AW, sharp border', impression: 'high grade' , ECC: 'Yes')
   HSIL13Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 13 NS.jpg', image_set: HSIL13)

   HSIL13AW1 = Image.create(image_type: 'Acetic Acid 1', img_url: 'HSIL 13 AW.jpg', ans_img_url: 'InkedHSIL 13 AW_LI.jpg', image_set: HSIL13)
   ...
   HSIL13AW2 = Image.create(image_type: 'Acetic Acid 2', img_url: 'HSIL 13 AW 2.jpg', ans_img_url: 'InkedHSIL 13 AW 2_LI.jpg', image_set: HSIL13)
...
HSIL14 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '3:00 - 9:00', findings: 'dense AW, cuffed crypt, sharp border, rag sign', impression: 'high grade' , ECC: 'Yes')
   HSIL14Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 14 NS.jpg', image_set: HSIL14)

   HSIL14AW1 = Image.create(image_type: 'Acetic Acid 1', img_url: 'HSIL 14 AW.jpg', ans_img_url: 'InkedHSIL 14 AW_LI.jpg', image_set: HSIL14)
   ...
   HSIL14AW2 = Image.create(image_type: 'Acetic Acid 2', img_url: 'HSIL 14 AW 2.jpg', ans_img_url: 'InkedHSIL 14 AW 2_LI.jpg', image_set: HSIL14)
   ...
   HSIL14AW3 = Image.create(image_type: 'Acetic Acid 3', img_url: 'HSIL 14 AW 3 into vagina.jpg', ans_img_url: 'InkedHSIL 14 AW 3 into vagina_LI.jpg', image_set: HSIL14)
   ...
   HSIL14AWZoom = Image.create(image_type: 'Acetic Acid 4', img_url: 'HSIL 14 AW zoom.jpg', ans_img_url: 'InkedHSIL 14 AW zoom_LI.jpg', image_set: HSIL14)
...
HSIL19 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '4:00 - 8:00', findings: 'dense AW, sharp border', impression: 'high grade' , ECC: 'Yes')
   HSIL19Pre = Image.create(image_type: 'Speculum Exam', img_url: 'HSIL 19 pre.jpg', image_set: HSIL19)

   HSIL19AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 19 AW.jpg', ans_img_url: 'InkedHSIL 19 AW_LI.jpg', image_set: HSIL19)
   ...
   HSIL19AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'HSIL 19 AW green.jpg', ans_img_url: 'InkedHSIL 19 AW_LI.jpg', image_set: HSIL19)
   ...
   HSIL19Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 19 Lugol_s.jpg', ans_img_url: 'InkedHSIL 19 Lugol_s_LI.jpg', image_set: HSIL19)
...
HSIL20 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '12:00, 4:00-7:00', findings: 'dense AW, sharp border, cuffed crypts, erosion', impression: 'high grade' , ECC: 'No')
   HSIL20Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 20 NS.jpg', image_set: HSIL20)

   HSIL20AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 20 AW.jpg', ans_img_url: 'InkedHSIL 20 AW_LI.jpg', image_set: HSIL20)
   ...
   HSIL20Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 20 Lugol_s.jpg', ans_img_url: 'InkedHSIL 20 Lugol_s_LI.jpg', image_set: HSIL20)
...
HSIL22 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '10:00 - 2:00', findings: 'dense AW, sharp border, erosion, abnormal vessel', impression: 'high grade' , ECC: 'No')
   HSIL22Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 22 NS.jpg', image_set: HSIL22)

   HSIL22AW1 = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 22 AW.jpg', ans_img_url: 'InkedHSIL 22 AW_LI.jpg', image_set: HSIL22)
   ...
   HSIL22Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 22 Lugol_s.jpg', ans_img_url: 'InkedHSIL 22 Lugol_s_LI.jpg', image_set: HSIL22)
...
HSIL26 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '4:00 - 6:00', findings: 'dense AW, sharp border, cuffed crypts, erosion', impression: 'high grade' , ECC: 'No')
   HSIL26Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 26 NS.jpg', image_set: HSIL26)

   HSIL26AW1 = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 26 AW.jpg', ans_img_url: 'InkedHSIL 26 AW_LI.jpg', image_set: HSIL26)
   ...
   HSIL26Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 26 Lugol_s.jpg', ans_img_url: 'InkedHSIL 26 Lugol_s_LI.jpg', image_set: HSIL26)
...
HSIL27 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '7:00 - 4:00', findings: 'coarse punctation, sharp border', impression: 'high grade' , ECC: 'Yes')
   HSIL27Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 27 NS.jpg', image_set: HSIL27)

   HSIL27AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 27 AW.jpg', ans_img_url: 'InkedHSIL 27 AW_LI.jpg', image_set: HSIL27)
...
HSIL35 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '8:00', findings: 'dense AW, sharp border, coarse punctation', impression: 'high grade' , ECC: 'Yes')
   ...
   HSIL35AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 35 AW.jpg', ans_img_url: 'InkedHSIL 35 AW green_LI.jpg', image_set: HSIL35)
   ...
   HSIL35AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'HSIL 35 AW green.jpg', ans_img_url: 'InkedHSIL 35 AW green_LI.jpg', image_set: HSIL35)
...
HSIL37 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '5:00 - 8:00', findings: 'dense AW, sharp border, cuffed crypts, erosion', impression: 'high grade' , ECC: 'Yes')
   HSIL37Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 37 NS.jpg', image_set: HSIL37)

   HSIL37AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 37 AW.jpg', ans_img_url: 'InkedHSIL 37 AW_LI.jpg', image_set: HSIL37)
   ...
   HSIL37Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 37 Lugol_s.jpg', ans_img_url: 'InkedHSIL 37 Lugol_s_LI.jpg', image_set: HSIL37)
...
HSIL38 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '4:00 - 9:00', findings: 'dense AW, sharp border, cuffed crypts', impression: 'high grade' , ECC: 'Yes')
   HSIL38Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 38 NS.jpg', image_set: HSIL38)

   HSIL38AW1 = Image.create(image_type: 'Acetic Acid 1', img_url: 'HSIL 38 AW.jpg', ans_img_url: 'InkedHSIL 38 AW_LI.jpg', image_set: HSIL38)
   ...
   HSIL38AW2 = Image.create(image_type: 'Acetic Acid 2', img_url: 'HSIL 38 AW 2.jpg', ans_img_url: 'InkedHSIL 38 AW 3_LI.jpg', image_set: HSIL38)
...
HSIL39 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '8:00 - 2:00', findings: 'dense AW, sharp border, coarse punctation, cuffed crypts', impression: 'high grade' , ECC: 'Yes')
   HSIL39Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 39 NS.jpg', image_set: HSIL39)

   HSIL39AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 39 AW.jpg', ans_img_url: 'InkedHSIL 39 AW_LI.jpg', image_set: HSIL39)
   ...
   HSIL39AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'HSIL 39 AW green.jpg', ans_img_url: 'InkedHSIL 39 AW green_LI.jpg', image_set: HSIL39)
...
HSIL44 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '2:00, 4:00', findings: 'AW, leukoplakia', impression: 'high grade' , ECC: 'Yes')
   ...
   HSIL44AW1 = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 44 AW.jpg', ans_img_url: 'InkedHSIL 44 AW_LI.jpg', image_set: HSIL44)
...
#LOW GRADE dysplasia---------------------------------------------------------------------
LSIL2 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '12:00', findings: 'thin AW, irregular border, fine mosaic', impression: 'low grade' , ECC: 'No')
   LSIL2Pre = Image.create(image_type: 'Normal Saline', img_url: 'LSIL 2 NS.jpg', image_set: LSIL2)

   LSIL2AW = Image.create(image_type: 'Acetic Acid', img_url: 'LSIL 2 AW.jpg', ans_img_url: 'LSIL 2 AW outlined.jpg', image_set: LSIL2)
   ...
   LSIL2AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'LSIL 2 AW green.jpg', ans_img_url: 'LSIL 2 AW green outlined.jpg', image_set: LSIL2)
   ...
   LSIL2Lugols = Image.create(image_type: "Lugol's", img_url: 'LSIL 2 Lugol_s.jpg', ans_img_url: 'LSIL 2 Lugol outlined.jpg', image_set: LSIL2)
...
LSIL4 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '7:00, 12:00', findings: 'thin AW, irregular border, fine mosaic', impression: 'low grade' , ECC: 'No')
   LSIL4Pre = Image.create(image_type: 'Normal Saline', img_url: 'LSIL 4 NS.jpg', image_set: LSIL4)

   LSIL4AW1 = Image.create(image_type: 'Acetic Acid 1', img_url: 'LSIL 4 AW 1.jpg', ans_img_url: 'LSIL 4 AW outlined.jpg', image_set: LSIL4)
   ...
   LSIL4AW2 = Image.create(image_type: 'Acetic Acid 2', img_url: 'LSIL 4 AW 2.jpg', ans_img_url: 'LSIL 4 AW zoom outlined.jpg', image_set: LSIL4)
      GreenArea.create(coordinates: '269,358,271,442,309,462,351,448,356,384,337,353,297,344,285,348', shape: 'poly', image: LSIL4AW2)
      GreenArea.create(coordinates: '269,358,271,442,309,462,351,448,356,384,337,353,297,344,285,348', shape: 'poly', image: LSIL4AW2)
   LSIL4Lugols = Image.create(image_type: "Lugol's", img_url: 'LSIL 4 Lugol_s.jpg', ans_img_url: 'LSIL 4 Lugol_s outlined.jpg', image_set: LSIL4)
...
LSIL5 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '7:00, 12:00', findings: 'thin AW, irregular border ', impression: 'low grade' , ECC: 'Yes')
   LSIL5Pre = Image.create(image_type: 'Normal Saline', img_url: 'LSIL 5 NS.jpg', image_set: LSIL5)

   LSIL5AW = Image.create(image_type: 'Acetic Acid', img_url: 'LSIL 5 AW.jpg', ans_img_url: 'LSIL 5 AW 2 outlined.jpg', image_set: LSIL5)
   ...
   LSIL5Lugols = Image.create(image_type: "Lugol's", img_url: 'LSIL 5 Lugol_s.jpg', ans_img_url: 'LSIL 5 Lugol_s outlined.jpg', image_set: LSIL5)
...
LSIL6 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '7:00, 12:00', findings: 'thin AW, irregular border, fine mosaic, geographic border', impression: 'low grade' , ECC: 'Yes')
   LSIL6Pre = Image.create(image_type: 'Speculum Exam', img_url: 'LSIL 6 AW.jpg', image_set: LSIL6)

   LSIL6AW = Image.create(image_type: 'Acetic Acid', img_url: 'LSIL 6 AW.jpg', ans_img_url: 'LSIL 6 AW_outlined.jpg', image_set: LSIL6)
   ...
   LSIL6AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'LSIL 6 AW green.jpg', ans_img_url: 'LSIL 6 AW green 2 outlined.jpg', image_set: LSIL6)
   ...
   LSIL6Lugols = Image.create(image_type: "Lugol's", img_url: 'LSIL 6 Lugol_s.jpg', ans_img_url: 'LSIL 6 Lugol_s_outlined.jpg', image_set: LSIL6)
...
LSIL7 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '11:00, 4:00-8:00', findings: 'thin AW, irregular border ', impression: 'low grade' , ECC: 'No')
   LSIL7Pre = Image.create(image_type: 'Normal Saline', img_url: 'LSIL 7 NS.jpg', image_set: LSIL7)

   LSIL7AW = Image.create(image_type: 'Acetic Acid', img_url: 'LSIL 7 AW.jpg', ans_img_url: 'LSIL 7 AW outlined.jpg', image_set: LSIL7)
   ...
   LSIL7AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'LSIL 7 AW green.jpg', ans_img_url: 'LSIL 7 AW green outlined.jpg', image_set: LSIL7)
   ...
   LSIL7Lugols = Image.create(image_type: "Lugol's", img_url: 'LSIL 7 Lugol_s.jpg', ans_img_url: 'LSIL 7 Lugol_s_outlined.jpg', image_set: LSIL7)
...
LSIL8 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '6:00, 12:00', findings: 'thin AW, irregular border ', impression: 'low grade' , ECC: 'No')
   LSIL8Pre = Image.create(image_type: 'Normal Saline', img_url: 'LSIL 8 NS.jpg', image_set: LSIL8)

   LSIL8AW = Image.create(image_type: 'Acetic Acid', img_url: 'LSIL 8 AW.jpg', ans_img_url: 'LSIL 8 AW outlined.jpg', image_set: LSIL8)
   ...
   LSIL8Lugols = Image.create(image_type: "Lugol's", img_url: 'LSIL 8 Lugol_s.jpg', ans_img_url: 'LSIL 8 Lugol_s_outlined.jpg', image_set: LSIL8)
...
LSIL10 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '6:00, 12:00', findings: 'thin AW, irregular border ', impression: 'low grade' , ECC: 'No')
   LSIL10Pre = Image.create(image_type: 'Normal Saline', img_url: 'LSIL 10 NS.jpg', image_set: LSIL10)

   LSIL10AW = Image.create(image_type: 'Acetic Acid', img_url: 'LSIL 10 AW.jpg', ans_img_url: 'LSIL 10 AW_outlined.jpg', image_set: LSIL10)
   ...
   LSIL10AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'LSIL 10 AW green.jpg', ans_img_url: 'LSIL 10 AW_outlined.jpg', image_set: LSIL10)
   ...
   LSIL10Lugols = Image.create(image_type: "Lugol's", img_url: 'LSIL 10 Lugol_s.jpg', ans_img_url: 'LSIL 10 Lugol_s_outlined.jpg', image_set: LSIL10)
...
LSIL11 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '8:00, 10:00', findings: 'thin AW, irregular border ', impression: 'low grade' , ECC: 'No')
   LSIL11Pre = Image.create(image_type: 'Normal Saline', img_url: 'LSIL 11 NS.jpg', image_set: LSIL11)

   LSIL11AW1 = Image.create(image_type: 'Acetic Acid 1', img_url: 'LSIL 11 AW.jpg', ans_img_url: 'LSIL 11 AW_outlined.jpg', image_set: LSIL11)
   ...
   LSIL11AW2 = Image.create(image_type: 'Acetic Acid 2', img_url: 'LSIL 11 AW 2.jpg', ans_img_url: 'LSIL 11 AW 2_outlined.jpg', image_set: LSIL11)
   ...
   LSIL11Lugols = Image.create(image_type: "Lugol's", img_url: 'LSIL 11 Lugol_s.jpg', ans_img_url: 'LSIL 11 Lugol_s_outlined.jpg', image_set: LSIL11)
...
LSIL13 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '7:00, 12:00', findings: 'dense AW, sharp border', impression: 'low grade' , ECC: 'Yes')
   LSIL13Pre = Image.create(image_type: 'Normal Saline', img_url: 'LSIL 13 NS.jpg', image_set: LSIL13)

   LSIL13AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'LSIL 13 AW green.jpg', ans_img_url: 'LSIL 13 AW green_outlined.jpg', image_set: LSIL13)
   ...
   LSIL13Lugols = Image.create(image_type: "Lugol's", img_url: 'LSIL 13 Lugol_s.jpg', ans_img_url: 'LSIL 13 Lugol_s_outlined.jpg', image_set: LSIL13)
...
LSIL14 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '11:00', findings: 'dense AW, sharp border', impression: 'low grade' , ECC: 'Yes')
   LSIL14Pre = Image.create(image_type: 'Normal Saline', img_url: 'LSIL 14 NS.jpg', image_set: LSIL14)

   LSIL14AW = Image.create(image_type: 'Acetic Acid', img_url: 'LSIL 14 AW.jpg', ans_img_url: 'LSIL 14 AW_outlined.jpg', image_set: LSIL14)
   ...
   LSIL14Lugols = Image.create(image_type: "Lugol's", img_url: 'LSIL 14 Lugol_s.jpg', ans_img_url: 'LSIL 14 Lugol_s_outlined.jpg', image_set: LSIL14)
...
LSIL15 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '6:00, 9:00, 12:00', findings: 'thin AW, irregular border, geographic', impression: 'low grade' , ECC: 'No')
   LSIL15Pre = Image.create(image_type: 'Normal Saline', img_url: 'LSIL 15 NS.jpg', image_set: LSIL15)

   LSIL15AW = Image.create(image_type: 'Acetic Acid', img_url: 'LSIL 15 AW.jpg', ans_img_url: 'LSIL 15 AW_outlined.jpg', image_set: LSIL15)
   ...
   LSIL15AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'LSIL 15 AW green.jpg', ans_img_url: 'LSIL 15 AW green_outlined.jpg', image_set: LSIL15)
   ...
   LSIL15Lugols = Image.create(image_type: "Lugol's", img_url: 'LSIL 15 Lugol_s.jpg', ans_img_url: 'LSIL 15 AW_outlined.jpg', image_set: LSIL15)
...
LSIL16 = ImageSet.create(category: 'Dysplasia: Low Grade', pathology: 'CIN 1', lesion_location: '1:00, 7:00', findings: 'thin AW, irregular border ', impression: 'low grade' , ECC: 'Yes')
   LSIL16Pre = Image.create(image_type: 'Normal Saline', img_url: 'LSIL 16 NS green.jpg', image_set: LSIL16)

   LSIL16AW = Image.create(image_type: 'Acetic Acid', img_url: 'LSIL 16 AW.jpg', ans_img_url: 'LSIL 16 AW_outlined.jpg', image_set: LSIL16)
   ...
   LSIL16AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'LSIL 16 AW green.jpg', ans_img_url: 'LSIL 16 AW_outlined.jpg', image_set: LSIL16)
   ...
   LSIL16Lugols = Image.create(image_type: "Lugol's", img_url: 'LSIL 16 Lugol_s.jpg', ans_img_url: 'LSIL 16 Lugol_s_outlined.jpg', image_set: LSIL16)
...
HSIL1 = ImageSet.create(category: 'Dysplasia: High Grade', pathology: 'CIN 3', lesion_location: '', findings: '', ECC: 'Yes')
   HSIL1Pre = Image.create(image_type: 'Normal Saline', img_url: 'HSIL 1 NS.jpg', ans_img_url: '', image_set: HSIL1)
   HSIL1Pre = Image.create(image_type: 'Speculum Exam', img_url: 'HSIL 1 pre.jpg', ans_img_url: '', image_set: HSIL1)

   HSIL1AW = Image.create(image_type: 'Acetic Acid', img_url: 'HSIL 1 AW.jpg', ans_img_url: '', image_set: HSIL1)
      GreenArea.create(coordinates: '', shape: 'poly', image: HSIL1AW)
      BlueArea.create(image: HSIL1AW)
   HSIL1AWGreen = Image.create(image_type: 'Acetic Acid + Green Filter', img_url: 'HSIL 1 AW green.jpg', ans_img_url: '', image_set: HSIL1)
      GreenArea.create(coordinates: '', shape: 'poly', image: HSIL1AWGreen)
      BlueArea.create(image: HSIL1AWGreen)
   HSIL1Lugols = Image.create(image_type: "Lugol's", img_url: 'HSIL 1 Lugol_s.jpg', ans_img_url: '', image_set: HSIL1)
